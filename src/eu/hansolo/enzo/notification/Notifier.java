...
import static eu.hansolo.enzo.notification.Notifier.INSTANCE;
...
public enum Notifier {
     ...
     * given Stage.<br>
     * If null then the Notification will be positioned relative to the primary
     * Screen.
     ...
     * <code>setPopupLocation</code> is called
     ...
     * before it will fade out. The parameter is limited to values between 2 and
     * 20 seconds.
     *
    ...
    /**
     * Reorder the popup Notifications on screen so that the latest Notification
     * will stay on top
     */
